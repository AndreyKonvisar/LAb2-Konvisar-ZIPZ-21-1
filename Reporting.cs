...
namespace lab_2
{
    ...
    internal class Reporting : IGetterInvoices, IGetterBalances
    {
        ...
        {
            global::System.Console.WriteLine($"Товар {product.ProductName} продано зi складу {warehouseName}"); 
        }
        ...
        {
            global::System.Console.WriteLine($"На {warehouse.WarehouseName} {warehouse.Count} залишкiв");
        }
